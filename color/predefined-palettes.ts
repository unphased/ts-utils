...
// the tones all go from light to dark and there are always 10 of them. Given the largest one has 22 hues that makes
// for 220 values which is more than enough for any job.
...
// given some requirement of color palettes, generate one out of the predetermined group by employing heuristics.
export const generatedPalette = (hues: number, tones: number) => {
